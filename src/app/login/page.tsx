...
export default function Example() {
	return (
		<>
			<div className="bg-gray-50 flex flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8"
				style={
					{minHeight: '100vh'}
			}>
				<div className="sm:mx-auto sm:w-full sm:max-w-md">
					<Link href='/'>
						<img className="mx-auto h-10 w-auto" src="https://seeklogo.com/images/E/e-commerce-concept-logo-5146F23CC5-seeklogo.com.png" alt="Your Company"/>
					</Link>
