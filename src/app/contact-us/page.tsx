export default function Example() {
  const offices = [
    {
      name: "Los Angeles",
      address1: "4556 Brendan Ferry",
      address2: "Los Angeles, CA 90210",
    },
    {
      name: "New York",
      address1: "886 Walter Street",
      address2: "New York, NY 12345",
    },
    {
      name: "Toronto",
      address1: "7363 Cynthia Pass",
      address2: "Toronto, ON N3Y 4H8",
    },
    {
      name: "London",
      address1: "114 Cobble Lane",
      address2: "London N1 2EF",
    },
  ];
  return (
    <>
