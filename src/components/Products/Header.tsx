...
import {sortOptions} from '@/dummyData'


const Header = ({handleOpenToggle}: any) => {
										...
										<Menu.Item key={
											...
											{({active}) => (
												<a href={
													...
													className={
														classNames(option.current ? 'font-medium text-gray-900' : 'text-gray-500', active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm')
												}>
													{
													option.name
												} </a>)}
